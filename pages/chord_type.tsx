    ...
    return (
        ...
        <Main>
            ...
            <section>
                ...
                <section>
                    <h3>根音（ルート）：(R)</h3>
                    <p>単音は和音（コード）ではないが、この単音を根音（ルート）としてその上に構成音を重ねていくと和音になる。このルートを鍵盤数1とする。単音なので記号はないが他と区別するためにルートの頭文字(R)とした。</p>
                    <figure>
                ...
                <section>
                    <h3>パワーコード：5</h3>
                    <p>三和音（トライアド）に五度（フィフス）を加えた二和音。鍵盤数は1,8。五度はルートともっとも調和し単音より力強い響きになる。メジャー、マイナーの性格は持たない。記号はルートに五度だけを足すので「5」がつく。</p>
                    <figure>
            ...
            <section>
                ...
                <section>
                    <h3>メジャー：(M)</h3>
                    <p>パワーコードに長三度（サード）の音を足す。鍵盤数は1,5,8。明るい響き。記号は大文字のMだが略されることが多いため(M)とした。</p>
                    <figure>
                ...
                <section>
                    <h3>マイナー：m</h3>
                    <p>メジャーコードの三度が半音下げる（短三度）。鍵盤数は1,4,8。悲しい響き。記号は小文字のm。</p>
                    <figure>
                ...
                <section>
                    <h3>ディミニッシュ：dim</h3>
                    <p>マイナーコードから五度の音を半音下げる（減五度）。鍵盤数では1, 4, 7。ちょっと不穏な響き。記号はdim。</p>
                    <figure>
                ...
                <section>
                    <h3>オーギュメント：aug</h3>
                    <p>メジャーコードから五度の音を半音上げる（増五度）。鍵盤数は1, 5, 9。マイナーほど暗くないがちょっと不思議な響き。記号はaug。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>メジャーコードから三度の音を四度（フォース）にあげる。鍵盤数は1, 6, 8。まだ続きがありそう（未解決的）な響き。記号はsus4。</p>
                    <figure>
            ...
            <section>
                ...
                <section>
                    <h3>メジャーセブンス：M7</h3>
                    <p>トライアドのメジャーコードに長七度（メジャーセブンス）を加える。鍵盤数は1, 5, 8, 12。メジャーコードと比べるとより明るく豊かな響き。記号はM7。このMは七度にかかるM（三度のメジャーのMは略されている）</p>
                    <figure>
                ...
                <section>
                    <h3>セブンス：7</h3>
                    <p>メジャーセブンスから七度を半音下げる（短七度）。鍵盤数は1, 5, 8, 11。メジャーセブンスより少し悲しげな響き。七度ではマイナーのmが略されるので記号は数字の7のみ。呼び方もマイナーセブンスとは言わない（マイナーが五度、七度のどちらにかかっているかわからないため）。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>マイナーコードに長七度（メジャーセブンス）を加える。鍵盤数は1, 4, 8, 12。マイナーコードに力強さが加わる響き。記号はmM7。小文字mは三度、大文字Mは七度にかかっている。</p>
                    <figure>
                ...
                <section>
                    <h3>マイナー・セブンス：m7</h3>
                    <p>マイナー・メジャー・セブンスの七度を半音下げる（短七度）。鍵盤数は1, 4, 8, 11。マイナー・メジャー・セブンスより寂しげな響き。記号はm7。小文字mは三度にかかる。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>マイナー・セブンスの五度を半音下げる（減五度）。鍵盤数は1, 4, 7, 11。マイナー・セブンスよりさらに寂しげな響き。記号はm7(-5)。-5はカッコでくくる。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>ディミニッシュに短七度をさらに半音下げ（減七度）を加える。鍵盤数は1, 4, 7, 10。マイナー・セブンス・フラット・ファイブの七度をさらに半音さげる（減七度）とも言える。減七度は六度でもあるが、すべての構成音が+3の位置関係になる特殊なコード。記号はdim7。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>オーギュメントに長七度（メジャーセブンス）を加える。鍵盤数は1, 5, 9, 12。オーギュメントの響きに力強さが加わる。記号はaugM7。Mは七度にかかる。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>オーギュメント・メジャー・セブンスの七度を半音下げる（短七度）。鍵盤数は1, 5, 9, 11。オーギュメント・メジャー・セブンスより寂しげな響き。記号はaug7。七度のmは略される。</p>
                    <figure>
