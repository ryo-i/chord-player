    ...
    return (
        ...
        <Main>
            ...
            <section>
                ...
                <section>
                    <h3>根音（ルート）：(R)</h3>
                    <p>単音は和音ではないが、この単音を根音（ルート）としてその上に構成音を重ねていくと和音（コード）になる。このルートを鍵盤数1とする。</p>
                    <figure>
                ...
                <section>
                    <h3>パワーコード：5</h3>
                    <p>三和音（トライアド）に五度（フィフス）を加えた二和音。鍵盤数では1,8。五度はルートともっとも調和し単音より力強い響きになるがメジャー、マイナーの性格を持たない。記号はルートに五度だけを足すので「5」がつく。</p>
                    <figure>
            ...
            <section>
                ...
                <section>
                    <h3>メジャー：(M)</h3>
                    <p>パワーコードに長三度（サード）の音を足すとメジャーコードになる。鍵盤数では1,5,8。明るい響き。記号は大文字のMだが略されることが多い。</p>
                    <figure>
                ...
                <section>
                    <h3>マイナー：m</h3>
                    <p>メジャーコードの三度が半音下げる（短三度）とマイナーコードになる。鍵盤数では1,4,8。悲しい響き。記号は小文字のm。</p>
                    <figure>
                ...
                <section>
                    <h3>ディミニッシュ：dim</h3>
                    <p>マイナーコードから五度の音を半音下げる（減五度）とディミニッシュになる。鍵盤数では1, 4, 7。ちょっと不穏な響き。記号はdim。</p>
                    <figure>
                ...
                <section>
                    <h3>オーギュメント：aug</h3>
                    <p>メジャーコードから五度の音を半音上げる（増五度）とオーギュメントになる。鍵盤数は1, 5, 9。マイナーほど暗くないがちょっと不思議な響き。記号はaug。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>メジャーコードから三度の音を四度（フォース）にあげるとサスペンデッド4thになる。鍵盤数は1, 6, 8。まだ続きがありそう（未解決的）な響き。記号はsus4。</p>
                    <figure>
            ...
            <section>
                ...
                <section>
                    <h3>メジャーセブンス：M7</h3>
                    <p>トライアドのメジャーコードに長七度（メジャーセブンス）を加えるとメジャーセブンスになる。鍵盤数は1, 5, 8, 12。メジャーコードと比べるとより明るく豊かな響き。記号はM7。このMは七度のM（三度のメジャーのMは略されている）</p>
                    <figure>
                ...
                <section>
                    <h3>セブンス：7</h3>
                    <p>メジャーセブンスから七度を半音下げる（短七度）とセブンスになる。鍵盤数は1, 5, 8, 11。メジャーセブンスより少し悲しげな響き。七度ではマイナーのmが略されるので記号は数字の7のみ。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>マイナーコードに長七度（メジャーセブンス）を加えるとマイナー・メジャー・セブンスになる（ややこしやw）。鍵盤数は1, 4, 8, 12。マイナーコードに力強さが加わる響き。記号はmM7。小文字mは三度、大文字Mは七度につく。</p>
                    <figure>
                ...
                <section>
                    <h3>マイナー・セブンス：m7</h3>
                    <p>マイナー・メジャー・セブンスの七度を半音下げる（短七度）とマイナー・セブンスになる。鍵盤数は1, 4, 8, 11。マイナー・メジャー・セブンスより寂しげな響き。記号はm7。小文字mは三度につく。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>マイナー・セブンスの五度を半音下げる（減五度）とマイナー・セブンス・フラット・ファイブになる。鍵盤数は1, 4, 7, 11。マイナー・セブンスよりさらに寂しげな響き。記号はm7(-5)。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>ディミニッシュに短七度をさらに半音下げた音（減七度）を加えるとディミニッシュ・セブンスになる。マイナー・セブンス・フラット・ファイブの短七度をさらに半音さげた状態とも言える。鍵盤数は1, 4, 7, 10。減七度はルートからみると六度だがすべての構成音が+3の位置になる特殊なコード。記号はdim7。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>オーギュメントに長七度（メジャーセブンス）を加えるとオーギュメント・メジャー・セブンスになる。鍵盤数は1, 5, 9, 12。オーギュメントの響きに力強さが加わる。記号はaugM7。Mは七度につく。</p>
                    <figure>
                ...
                <section>
                    ...
                    <p>オーギュメント・メジャー・セブンスの七度を半音下げる（短七度）とオーギュメント・セブンスになる。鍵盤数は1, 5, 9, 11。オーギュメント・メジャー・セブンスより寂しげな響き。記号はaug7。七度のmは略される。</p>
                    <figure>
